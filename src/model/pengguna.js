...
const updatePengguna = (idPengguna, data) => {
    ...
    // Memberikan pelindung (fallback) agar jika kosong menjadi NULL, bukan undefined
...
const findPenggunaById = async (idPengguna) => {
    const SQL = 'SELECT id_pengguna, nama, email, password, nomor_telepon, role, foto_profil, created_at, updated_at FROM pengguna WHERE id_pengguna = ? LIMIT 1';
